...
- الإعداد `content` جوه tailwind.config.js بيمسح `index.html` و`analysis.js` عشان يلقط كل الكلاسات اللي بتتولّد ديناميكياً من الجافاسكريبت (كروت المنتجات، السلة، إلخ) مش بس اللي في الـ HTML الثابت.
